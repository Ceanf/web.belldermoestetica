...
// Cambia color y sombra del header al hacer scroll
...
// Animación hover para botones y enlaces
...
function filtrarServicios(categoria) {
  ...
  tarjetas.forEach(card => {
    const esDeCategoria = card.dataset.categoria === categoria;
    if (categoria === 'todos' || esDeCategoria) {
